  ...
  async function submitHandler() {
    try {
      ...
      if (serverMessage.success === true) {
        ...
        localStorage.clear();
        localStorage.setItem("faculty", JSON.stringify(serverMessage.data));
        setUsername("");
        setPassword("");
      ...
      <div className={currentStyles.container}>
        ...
        >
          <div className={currentStyles.formWrapper}>
            {/* Header row: Centered title and small toggle button at right */}
            <div className={currentStyles.headerRow}>
              <p className={currentStyles.heading}>Faculty Login</p>
        ...
        <div
          ...
          style={{ backgroundImage: "url(/Images/Designer.png)" }}
        ></div>
      </div>
    </div>
  );
